...
function updatePointCloud(vertexPosition,vertexVelocity,vertexColor,vertexAge,n,dt, sx,ex,sy,ey,sz,ez,svx,evx,svy,evy,svz,evz,sa,ea)
{
  ...
  async function startGL() 
  {
    ...
    [indexes, vertexPosition, vertexNormal, vertexCoord] = await LoadObj('fireplace.obj');
    [vertexPosition2, vertexVelocity, vertexColor, vertexAge] = CreatePointCloud(sx,ex,sy,ey,sz,ez,svx,evx,svy,evy,svz,evz,sa,ea,50000);
  ...
  textureImg.src="gun-metal-russia-32x.png"; //Nazwa obrazka
  ...
  var LightPositionZ = 8;

  var CloudPositionX = -0.5;
  var CloudPositionY = -1.5;
  var CloudPositionZ = -1.5;
  
  function Tick()
  { 
    [vertexPosition2, vertexVelocity, vertexColor, vertexAge] = updatePointCloud(vertexPosition2,vertexVelocity,vertexColor,vertexAge,50000,0.01, sx,ex,sy,ey,sz,ez,svx,evx,svy,evy,svz,evz,sa,ea);
    ...
    uMMatrix2 = MatrixMul(uMMatrix2,CreateTranslationMatrix(CloudPositionX,CloudPositionY,CloudPositionZ));  
    ...
    gl.drawArrays(gl.POINTS, 0, vertexPositionBuffer2.numItems*vertexPositionBuffer2.itemSize); //Faktyczne wywołanie rendrowania
